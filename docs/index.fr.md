...
openBIM | Données                          
---------------------------------------------------------|-----------
Les données OpenBIM doivent être **lisibles** pour tous, **commentables** pour beaucoup et **modifiables** pour quelques-uns. | ![Screenshot](img/data.png)
